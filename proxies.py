...
#Load Proxies
def load_proxy():
    loadproxy = easygui.fileopenbox(msg="Load Your Proxies", title="Proxies", default='*', filetypes=["*.txt"], multiple=False)
    with open(loadproxy,"r",encoding="utf8",errors="replace") as proxy_file:
